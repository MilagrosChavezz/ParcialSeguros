...
public class SegundoParcial {
	...
	@Test
	public void queSePuedaDenunciarElRoboDeUnAuto() throws NoExistePoliza {
		Integer numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
		...
		assertTrue(((IseguroGeneras) libra.getPoliza(1)).fueRobado());

	}

	@Test
	public void queSePuedaDenunciarUnSiniestroParaUnaPolizaDeVida() throws NoExistePoliza {
		Integer numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
		...
		assertTrue((((IPolizaPersonal) libra.getPoliza(1))).tuvoAlgunAccidente());

	}

	@Test (expected = NoExistePoliza.class) public void
	  verificarQueNoSePuedaDenunciarUnSiniestroParaUnaPolizaQueNoExista() throws NoExistePoliza { 
		Integer numeroDePoliza = 1; CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
